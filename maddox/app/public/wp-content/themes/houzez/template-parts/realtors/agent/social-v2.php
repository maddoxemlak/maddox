...
if( !empty( $agent_skype ) || !empty( $agent_facebook ) || !empty( $agent_instagram ) || !empty( $agent_twitter ) || !empty( $agent_linkedin ) || !empty( $agent_googleplus ) || !empty( $agent_youtube ) || !empty( $agent_pinterest ) || !empty( $agent_vimeo ) || !empty( $agent_whatsapp ) || !empty( $agent_tiktok ) || !empty( $agent_telegram ) || !empty( $agent_zillow ) || !empty( $agent_realtor_com ) ) {
?>
